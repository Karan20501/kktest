<template>
    ...
    <div class="container max-w-2xl p-8 mx-auto bg-white shadow-lg rounded-lg" v-if="settings">
        <div class="flex flex-col items-center">
            <!-- Logo -->
            <img src="/img/logo.png" alt="Logo" class="logo mb-5" /> <!-- Add your logo image path -->
            ...
            <div class="flex flex-col w-full">
                <div>
                    <label for="email" class="text-sm font-light text-gray-500">{{ $t('login.email') }}</label>
                ...
                <div>
                    <label for="password" class="text-sm font-light text-gray-500">{{ $t('login.password') }}</label>
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label for="code" class="text-sm font-light text-gray-500">Enter Code</label>
